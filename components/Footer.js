    ...
    <div className="">
      <div className="max-w-screen-lg mx-auto px-2 sm:px-6 lg:px-8">
        <div className="relative flex flex-col items-center justify-center py-10">
          <Link href="/">
            <div className="flex flex-col justify-center items-center text-gray-400 cursor-pointer hover:text-gray-800 md:text-xl mb-3 md:mb-5">
              <IoIosArrowUp />
              <p>Back to top</p>
            </div>
          </Link>
          ...
          <div className="flex flex-row text-3xl text-gray-400 mt-5">
            <a href="https://github.com/LihaoWang">
              <FaGithubAlt className="mx-2 hover:text-gray-800" />
            </a>
